...
%            ground.STATVAR.area = tile.PARA.area + ground.STATVAR.T .* 0;
            ...
            ground.STATVAR.XwaterIce = ground.STATVAR.Xice./ (1 + ground.STATVAR.Xice) .* ground.STATVAR.initial_layerThick .* ground.STATVAR.area;
        ...
        function ground = advance_prognostic(ground, tile) 
            ...
            prognostic_layerThick = ground.STATVAR.saturation > 1-1e-6 & (ground.TEMP.d_water > 0 | (ground.TEMP.d_water < 0 & ground.TEMP.no_air) | (ground.TEMP.d_water < 0 & ground.STATVAR.Xvoid_ratio > ground.STATVAR.initial_voidRatio));
            ...
            %Update water and waterIce variables (Ice stays the same)
            ...
            ground.STATVAR.XwaterIce = max(0,ground.STATVAR.waterIce - ground.STATVAR.saturation .* ground.STATVAR.porosity .* ground.STATVAR.initial_layerThick .* ground.STATVAR.area);
            %ground.STATVAR.water = ground.STATVAR.waterIce - ground.STATVAR.ice;
            %ground.STATVAR.Xwater = ground.STATVAR.XwaterIce - ground.STATVAR.Xice;
